...
const char *fragment_frag =
 ...
 "{"
   ...
   "d=min(d,d/2.+4.);"
   "float m=A(d/2.);"
   "vec2 r=v-.15-t(vec2(floor(d/4.)))/2.;"
 ...
 "{"
   ...
   "vec2 i=vec2(.5),z=t(vec2(s-r+3.));"
   "vec3 x=vec3(1e3*m,0,0),n=vec3(0,0,-1);"
   "n.yz*=p(smoothstep(64.,80.,s)*3.-.2);"
   "n.xz*=p(.3);"
   "x.xz-=mix(smoothstep(0.,32.,191.-s)*vec2(0,-16),(8.-r)*z,m)*30.*d;"
   "i+=mix(smoothstep(0.,8.,r)-.5,1.,step(s,128.))*z*d*m*vec2(.5,.2);"
   "i.x+=y*f*3.*(step(208.,s)*2.-1.);"
   "x.y+=f*(1.-y)*4.;"
   "return B(v,i,x,n);"
 "}"
